...
class MydotdAdapter(private val context: Context, val doldlist: ArrayList<Dotd>, private var firestore: FirebaseFirestore,private var auth: FirebaseAuth) : RecyclerView.Adapter<MydotdAdapter.MyViewHolder>() {
